function [] = comparison_plot_2D(Pos_arr, Vel_arr, legend_arr, color_arr)

% Plots results from multiple 2D experiments into one figure, where the
...
for i = 1:input_count
    ...
    data_plot_2D(Pos,i_colors,"Positions comparison",':','.','o',i_legend)
end
...
for i = 1:input_count
    ...
    data_plot_2D(Vel,i_colors,"Velocities comparison",':','.','o',i_legend)
end

function [Pos,C_Pos,P_Center,Vel,C_Vel,V_Center] = experiment(iter, dt, K, sigma, beta, init_pos, init_vel)
...
% Simulates the discrete model (implicit Euler) and calculates additional
% properties.
%
% Arguments:
%
...
[Pos, Vel] = simulate_discrete(iter,dt,K,sigma,beta,X,V);
